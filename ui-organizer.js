...
function mount(){
 ...
 nav.innerHTML='<div class="nav-links"><button class="nav-chip active" data-target="#fileTesting">1 · File Testing</button><button class="nav-chip" data-target="#securitySuite3">2 · Extra</button><button class="nav-chip" data-target="#whatItDetects">3 · What It Detects</button><button class="nav-chip" data-target="#securitySuite">4 · Tool Center</button><button class="nav-chip" data-target="#securitySuite2">5 · Security Tool Center</button></div><label class="tool-search-wrap"><span class="search-icon">⌕</span><input class="tool-search" id="globalToolSearch" placeholder="Find a security tool…" aria-label="Find a security tool"><span class="search-count" id="toolSearchCount">31 tools</span></label>';
 header.after(nav);
