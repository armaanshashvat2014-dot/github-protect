const CACHE='github-protect-v38';
const CORE=['./','./index.html','./manifest.json','./icon.svg','./latest-version.json','./landing.css','./landing.js','./translator.js','./pro-upgrade.js','./traffic-engine.js','./security-suite.js','./security-assistant.js','./security-page.css','./pro/','./teams/'];
