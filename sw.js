const CACHE='github-protect-v36';
const CORE=['./','./index.html','./manifest.json','./icon.svg','./latest-version.json','./landing.css','./landing.js','./translator.js','./pro-upgrade.js','./traffic-engine.js','./security-suite.js','./security-page.css','./pro/','./teams/'];
